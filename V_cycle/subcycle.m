function [ u1,v1 ,norm1_r] = subcycle(level,u0,v0,I0,I1,pre_s,post_s,lambda,max_level,norm1_r)
...
[u1,v1,norm1_r]=subcycle(level+1,u1,v1,I0,I1,pre_s,post_s,lambda,max_level,norm1_r);
