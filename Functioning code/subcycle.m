function [ u1,v1 ,norm1_r,A,SMP] = subcycle(Syst_mat,RHS,level,u0,v0,M,N,pre_s,post_s,max_level,norm1_r,A,SMP,flag)
...
[up_u,up_v,norm1_r,A,SMP]=subcycle(Syst_mat_2,RHS_2,level+1,u0,v0,M/2,N/2,pre_s,post_s,max_level,norm1_r,A,SMP,flag);
